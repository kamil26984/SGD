...
def runLevel(levels, levelNum):
    ...
    while True: # main game loop
        ...
        if levelIsComplete:
            solvedFont = pygame.font.Font('freesansbold.ttf', 50)
            solvedSurf = solvedFont.render('Level Complete', True, (0, 255, 0))
            solvedRect = solvedSurf.get_rect()
            solvedRect.center = (HALF_WINWIDTH, HALF_WINHEIGHT)
            DISPLAYSURF.blit(solvedSurf, solvedRect)
